...
const options = ref<FormOption>({
    ...
    list: [
        ...
        { type: 'input', label: '学号', prop: 'studentId', required: true },
        { type: 'input', label: '年级', prop: 'grade', required: true },
        { type: 'input', label: '班级', prop: 'class', required: true },
...
const handleView = (row: Role) => {
    ...
    viewData.value.list = [
        ...
        { label: '学号', value: row.studentId },
        { label: '年级', value: row.grade },
        { label: '班级', value: row.class },
        { label: '状态', value: row.status ? '启用' : '禁用' },
        { },
